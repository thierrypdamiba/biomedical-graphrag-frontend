  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1">
        ...
        <a href="https://github.com/yourusername/bio-med-graphrag" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#DC244C] transition-colors">
          <Button variant="ghost" size="icon" className="h-8 w-8 text-inherit hover:text-inherit hover:bg-transparent">
        ...
        <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#DC244C] transition-colors">
          <Button variant="ghost" size="icon" className="h-8 w-8 text-inherit hover:text-inherit hover:bg-transparent">
        ...
        <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#DC244C] transition-colors">
          <Button variant="ghost" size="icon" className="h-8 w-8 text-inherit hover:text-inherit hover:bg-transparent">
